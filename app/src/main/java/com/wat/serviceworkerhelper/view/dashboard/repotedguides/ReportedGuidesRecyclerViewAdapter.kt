...
import com.wat.serviceworkerhelper.view.dashboard.repotedguides.SingleReportedGuideActivity.Companion.GUIDE_KEY
import com.wat.serviceworkerhelper.utils.MyRecyclerViewAdapter

class ReportedGuidesRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: GuideViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(it.context, SingleReportedGuideActivity::class.java).apply {
                putExtra(GUIDE_KEY, itemsList[position])
            }
    ...
    companion object {
        private const val TAG = "ReportedGuidesRVA"
    }
}